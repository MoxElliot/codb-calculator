...
<template>
    ...
    <div class="flex flex-col text-center items-center justify-center basis-full h-fit" @click="ellipsisModalisOpen === true ? closeEllipsisModal('') : ''">
      ...
      <div class="text-body2_xs md:text-body2 text-grey-300 basis-1/6 w-9/10 sm:w-8/10 lg:w-6/10">
        <p>
          A Fixed Cost is any Yearly or Monthly fee that you expect to pay in a regular year! Add
          the name of the cost, the category, the amount, and whether or not the cost is Monthly or
          Yearly.
        </p>
      </div>
