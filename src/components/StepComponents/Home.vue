...
<template>
  <BackgroundImage
    :tl-image="HomeBackgroundTL" tl-class="absolute top-4% left-0 h-40/100"
  ...
  <div class="flex flex-row justify-center basis-full">
    <div
      class="flex flex-col items-center justify-around basis-full md:basis-3/4 lg:basis-2/3 px-8 overflow-auto"
    >
      <div class="flex">
      ...
      <div class="font-sans text-grey-300 md:text-body2 text-body2_xs text-center">
        <p class="">Welcome to the Cost of Doing Business (CoDB) tool. With this spreadsheet, you'll be able to easily calculate how much it costs for you to run your business!</p>
      </div>
      <div
        class="flex info-blue font-sans text-blue-300 text-body_xs md:text-body my-2 md:m-6  md:py-6 md:pr-24 md:pl-16 p-3"
      >
        <img
