  ...
  <form class="fixed-cost-input" @submit.prevent>
        <fieldset name="fixed-cost-fieldset">
            <div class="fixed-cost-dataset">
                ...
                <input class="input expense-name-input" type="input" id="expense-name" v-model="fixedCostName"/>
            </div>
            <div class="fixed-cost-dataset">
            ...
            <div class="fixed-cost-dataset">
                ...
                <input class="input expense-amount-input" id="expense-amount" type="number" min="0" step="0.01" v-model="fixedCostAmount"/>
            </div>
        ...
        <button
            ...
            @click="reportStore.addFixedCostAction({id: reportStore.fixedCosts.length + 1, name: fixedCostName, category: fixedCostCategory, amount: fixedCostAmount, payPeriod: fixedCostPeriod})"
        >Add</button>
    </form>
</template>
